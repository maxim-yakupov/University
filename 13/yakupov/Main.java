...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        str = ("1-2 2-1 2-3 3-2 2-4 4-2 2-5 5-2 3-4 4-3 4-5 5-4 5-6 6-5").split(" ");
        System.out.print("Input string:");
        for (String s : str)
        {
            System.out.print(" " + s);
        ...
        System.out.println("Before changing:" + sgraph.toString());
        forDel = ("1-2 2-3 3-2 2-5 5-2 3-4 5-4 5-6 6-5").split(" ");
        for (String s : forDel) {
            String[] stt = s.split("-");
            int v1 = Integer.parseInt(stt[0]);
            int v2 = Integer.parseInt(stt[1]);
            System.out.println("Trying to remove " + v1 + "-" + v2 + ": "
                            + (sgraph.remove(v1, v2) ? "success" : "not in graph")
            );
        }
        System.out.println("After changing :  " + sgraph.toString());
    }
    ...
    private static void makeTests() {
        ...
        System.out.println("--------TESTS--------SGRAPH");
        for (String test : tests) {
            System.out.println(testSGraph(test) ? "Passed." : "Failed. test str: '" + test + "'");
        }
        System.out.println("-----END-OF-TESTS----SGRAPH");
    }
    ...
    public static boolean testSGraph(String testData) {
