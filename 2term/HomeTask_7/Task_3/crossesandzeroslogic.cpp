...
#include "ui_crossesandzeroslogic.h"

CrossesAndZerosLogic::CrossesAndZerosLogic(QWidget *parent, unsigned int size) :
    QWidget(parent),
    size(size),
    turn(0),
    ui(new Ui::CrossesAndZerosLogic)
{
    ui->setupUi(this);
...
CrossesAndZerosLogic::~CrossesAndZerosLogic()
{
    for (unsigned int i = 0; i < size; i++)
    {
        delete [] field[i];
...
void CrossesAndZerosLogic::playersTurn(unsigned int pos)
{
...
bool CrossesAndZerosLogic::isPart(int i, int j, unsigned int player)
{
    qDebug() << "isPart " << i << " " << j;
...
void CrossesAndZerosLogic::showMessage(unsigned int winner)
{
    if (winner == 1)
    {
...
bool CrossesAndZerosLogic::findWinner(unsigned int pos, unsigned int player)
{
...
void CrossesAndZerosLogic::computersTurn()
{
